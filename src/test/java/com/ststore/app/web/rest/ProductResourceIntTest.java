...
import com.ststore.app.repository.ProductRepository;
import com.ststore.app.repository.search.ProductSearchRepository;
import com.ststore.app.service.ProductService;
import com.ststore.app.service.dto.ProductDTO;
import com.ststore.app.service.mapper.ProductMapper;
...
public class ProductResourceIntTest {
    ...
    private static final BigDecimal DEFAULT_CAPITAL_PRICE = new BigDecimal(1);
    private static final BigDecimal UPDATED_CAPITAL_PRICE = new BigDecimal(2);
     ...
     *
     * @see com.ststore.app.repository.search.ProductSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product()
            ...
            .capitalPrice(DEFAULT_CAPITAL_PRICE)
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getCapitalPrice()).isEqualTo(DEFAULT_CAPITAL_PRICE);
    ...
    @Test
    @Transactional
    public void checkCapitalPriceIsRequired() throws Exception {
        int databaseSizeBeforeTest = productRepository.findAll().size();
        // set the field null
        product.setCapitalPrice(null);
    ...
    public void getAllProducts() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].capitalPrice").value(hasItem(DEFAULT_CAPITAL_PRICE.intValue())))
    ...
    public void getProduct() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products/{id}", product.getId()))
            ...
            .andExpect(jsonPath("$.capitalPrice").value(DEFAULT_CAPITAL_PRICE.intValue()))
    ...
    public void updateProduct() throws Exception {
        ...
        updatedProduct
            ...
            .capitalPrice(UPDATED_CAPITAL_PRICE)
        ...
        assertThat(testProduct.getCapitalPrice()).isEqualTo(UPDATED_CAPITAL_PRICE);
